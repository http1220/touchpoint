...
지금 실제로 돌아가고 있습니다 → **[동작 화면](https://lp.sshwan.com/l/8733)** · **[지표 화면](https://app.sshwan.com/metrics)**
...
| | |
|---|---|
| 결제 모듈 · 메타 채널 · 알림 | **없습니다.** 설계만 있고 실제 구현은 구글 채널 하나뿐입니다 |
| 가입 · 결제 화면 | 주소만 잡혀 있고 화면이 없습니다 |
