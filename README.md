...
지금 실제로 돌아가고 있습니다 → **[시연 안내](https://sshwan.com/tour)**(여기부터) · **[결제 해 보기](https://sshwan.com/tour#pay)** · [결제 이력](https://app.sshwan.com/pay/history) · [웹툰 홈](https://sshwan.com/) · [광고 랜딩](https://lp.sshwan.com/l/1) · [지표 화면](https://app.sshwan.com/metrics)
...
4. [결제 이력](https://app.sshwan.com/pay/history)에서 방금 만든 결제를 **"이 브라우저에서 만든 결제"** 로 다시 찾습니다. 입장권 없이 열리고, 지금까지의 결제 전부가 출처(방문자 버튼 · 면접 시연 · 동시성 측정 · 환불 시험 …)와 함께 있습니다
