...
| 4 | ~~Meta CAPI~~ | 어댑터(09-14, 실측 6파일) · 결제 경로 브라우저 맥락 보존(09-15) · `/conversion` 경로·픽셀 코드(09-15). 운영 전송 전환(09-15). 남은 것은 처리방침 고지 후 픽셀 켜기 · 실전환이 쌓인 뒤 EMQ 확인 → [ADR-005](decisions/ADR-005-channel-adapter.md) |
